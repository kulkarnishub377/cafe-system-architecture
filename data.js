...
const DataStore = {
    getMenuItems() {
        const stored = localStorage.getItem('vrs_menu');
        if (stored) return JSON.parse(stored);
        localStorage.setItem('vrs_menu', JSON.stringify(menuItems));
        return menuItems;
    },
    
    saveMenuItems(items) {
        localStorage.setItem('vrs_menu', JSON.stringify(items));
    },
    ...
    // Session Management
    getSessions() {
        const stored = localStorage.getItem('vrs_sessions');
        return stored ? JSON.parse(stored) : {};
    },
    
    saveSessions(sessions) {
        localStorage.setItem('vrs_sessions', JSON.stringify(sessions));
    },
    ...
    closeSession(tableNum) {
        ...
        if (session) {
            ...
            localStorage.setItem('vrs_sales', JSON.stringify(history));
    ...
    // Kitchen Orders
    getKitchenOrders() {
        const stored = localStorage.getItem('vrs_kitchen');
        return stored ? JSON.parse(stored) : [];
    },
    
    saveKitchenOrders(orders) {
        localStorage.setItem('vrs_kitchen', JSON.stringify(orders));
    },
    ...
    // Sales History
    getSalesHistory() {
        const stored = localStorage.getItem('vrs_sales');
        return stored ? JSON.parse(stored) : [];
    },
    ...
    // Settings
    getSettings() {
        const stored = localStorage.getItem('vrs_settings');
        return stored ? JSON.parse(stored) : {
    ...
    saveSettings(settings) {
        localStorage.setItem('vrs_settings', JSON.stringify(settings));
    },
